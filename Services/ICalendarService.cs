...
namespace finalesYaBackend.Services
{
    public interface ICalendarService
    {
        ...
        Task<CalendarReadDto?> GetByIdAsync(int id);
        ...
        Task<CalendarReadDto?> UpdateAsync(int id, CalendarCreateDto dto);
        ...
        Task<IEnumerable<CalendarReadDto>> GetByUserIdAsync(int userId);
        ...
        Task<CalendarViewDto> GetCalendarViewAsync(int userId, int year, int month);
        ...
        Task<IEnumerable<CalendarExamDto>> GetExamsByDateRangeAsync(int userId, DateTime startDate, DateTime endDate);
        ...
        Task<CalendarStatistics> GetCalendarStatisticsAsync(int userId);
    }
}